...
public final class QueryUtils {
    ...
    private static List<Movie> extractFeatureFromJson(String movieJson) {
        ...
        try {
            ...
            // For each news in the movieArray, create an {@link Movie} object.
            for (int i = 0; i < movieArray.length(); i++) {
                // Get a single news at position i within the list of movies.
                ...
                Movie movie = new Movie(title, releaseDate, moviePoster, userRating, plotSynopsis);
